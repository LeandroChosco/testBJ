...
//   componentDidMount() {
//     // conections.getLimitsCam()
//     //   .then((response) => {
//     //     if (response) {
//     //       const { data } = response;
//     //       if (data.success && data.data && data.data.length > 0) {
//     //         this.setState({ datosAlcaldia: data.data }, () => {
//     //           // const alcaldia = this.state.datosAlcaldia[0];
...
//           return data;
//         });
//         console.log("ALL SOS MESSAGES: ", chatSOS);
...
//       .get()
//       .then((docs) => {
//         console.log("EN EL DOC DEL CHAT C5");
...
//       .orderBy("lastModification", "desc")
//       .onSnapshot((docs) => {
//         console.log("EN LA ALERTA SOS");
//         let changes = docs.docChanges();
//         console.log("LOS DOCUMENTOS QUE CAMBIARON: ", changes);
//         console.log("EL CHAT ACTUAL DE SOS: ", this.state.stateSos);
//         // if (changes.length > 0) {
//         //   if (changes[0].type === "added" && changes.length < 10) {
//         //     if (this.state.fisrtTimeChat) this.setState({ fisrtTimeChat: false });
//         //     let chats = docs.docs.map((v) => {
//         //       let value = v.data();
//         //       value.lastModification = new Date(
//         //         value.lastModification.toDate()
//         //       ).toLocaleString();
...
//         //     console.log(index);
//         //     console.log(data);
//         //     if (this.state.stateSos[index]) {
//         //       if (
//         //         this.state.stateSos[index].messages.length === data.messages.length
//         //       ) {
...
//             console.log("LA LONGITUD DE LOS ARREGLOS DE MENSAJES: ", this.state.chats[index].messages.length, data.messages.length)
...
//                 !this.state.callIsGoing
//               ) {
//                 console.log("PARA ACTIVAR NOTIFICACION ****")
//                 this.setState({ reproducirSonido: true, chats });
//                 this.showNot(
//                   'Mensaje de usuario',
...
//     console.log("DENTRO DE SHOW NOT PARA MOSTRAR LA NOTIFICACION");
//     const notification = this.refs.notificationSystem;
//     console.log(notification, this.state.stopNotification, this.state.callIsGoing)
//     console.log(notification && !this.state.stopNotification && !this.state.callIsGoing);
