  ...
  render() {
    ...
    <Router> 
      ...
      <div className="fullcontainer">                
        ...
        <Route path="/dashboard" exact render={(props) => <Dashboard {...props}  _newCovidItem = {this._newCovidItem} newCovidState={this.state.newCovidState} newCovidItem = {this.state.newCovidItem} alertaCovid={this.state.alertaCovid}  canAccess={this.canAccess}  showMatches={this.state.showMatches} userInfo={this.state.userInfo} toggleSideMenu = {this._cameraSideInfo} toggleControls={this._toggleControls}/>} />
