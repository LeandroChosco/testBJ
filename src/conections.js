...
export default {
    ...
    dashboardTotalRecognition:()=>{        
        return Axios.get(/* constants.base_url+ */constants.base_url + ':1337/dashboard/detected')
    },
    dashboardRecognitionAges:()=>{        
        return Axios.get(/* constants.base_url+ */constants.base_url + ':1337/dashboard/ageranges')
    },
    dashboardRecognitionPerDay:(filter = '')=>{        
        return Axios.get(/* constants.base_url+ */constants.base_url + ':1337/dashboard/peoplefordays'+filter)
    },
    dashboardRecognitionMood:()=>{        
        return Axios.get(/* constants.base_url+ */constants.base_url + ':1337/dashboard/mood')
    },
    loadCams:()=>{        
