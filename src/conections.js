...
export default {
  ...
  restartStream: (dns = constants.apiStream) => {
    return Axios.put(
      dns + ":" + constants.apiPort + "/control-cams/restart-streaming3/all"
    );
  },
  restartOneStream: (dns = constants.apiStream, id) => {
    return Axios.put(
      dns + ":" + constants.apiPort + "/control-cams/restart-streaming3/" + id
    );
  },
  sendTicket: data => {
    return Axios.post(
      constants.base_url + ":" + constants.apiPort + "/tickets",
      data
    );
  },
  snapShot: camara_id => {
  ...
  getAllCams: () => {
    ...
    return Axios.get(
      constants.base_url +
        ":" +
        constants.apiPort +
        "/register-cams/all-cams?user_id=" +
        user_id
    );
  },
  ...
  getTicket: id => {
    return Axios.get(
      constants.base_url + ":" + constants.apiPort + "/tickets/" + id
    );
  },
  toProcess: data => {
    data.user_id = getUserID();
    return Axios.put(
      constants.base_url + ":" + constants.apiPort + "/tickets/toProcess",
      data
    );
  },
  toClose: data => {
    data.user_id = getUserID();
    return Axios.put(
      constants.base_url + ":" + constants.apiPort + "/tickets/toClose",
      data
    );
  },
  dashboardCams: () => {
    return Axios.get(constants.sails_url + ":1337/dashboard/cams");
  },
  dashboardTickets: () => {
    return Axios.get(constants.sails_url + ":1337/dashboard/tickets");
  },
  dashboardTotalRecognition: () => {
    return Axios.get(constants.sails_url + ":1337/dashboard/detected");
  },
  dashboardRecognitionAges: () => {
    return Axios.get(constants.sails_url + ":1337/dashboard/ageranges");
  },
  dashboardRecognitionPerDay: (filter = "") => {
    return Axios.get(
      constants.sails_url + ":1337/dashboard/peoplefordays" + filter
    );
  },
  dashboardRecognitionMood: () => {
    return Axios.get(constants.sails_url + ":1337/dashboard/mood");
  },
  loadCams: () => {
    return Axios.get(
      constants.sails_url +
        ":1337/cams?sort=num_cam asc&active=1&limit=1000&populate=false"
    );
  },
  changeCamStatus: id => {
    return Axios.put(
  ...
  loadCamsCuadrantes: id_cuadrante => {
    return Axios.get(
      constants.base_url +
        ":" +
        constants.apiPort +
        "/register-cams/cuadrantes-cams?id_cuadrante=" +
        id_cuadrante
    );
  },
  getCuadrantes: () => {
    return Axios.get(
      constants.base_url + ":" + constants.apiPort + "/register-cams/cuadrantes"
    );
  },
  newCuadrante: data => {
    return Axios.post(
  ...
  getCamsCuadrante: id_cuadrante => {
    return Axios.get(
      constants.base_url +
        ":" +
        constants.apiPort +
        "/register-cams/cuadrante/cams?id_cuadrante=" +
        id_cuadrante
    );
  },
  deleteCuadrante: id_cuadrante => {
    return Axios.put(
      constants.base_url +
        ":" +
        constants.apiPort +
        "/register-cams/cuadrante?id_cuadrante=" +
        id_cuadrante
    );
  },
  ...
  getMoreInformationByCam: num_cam => {
    return Axios.get(
      constants.base_url +
        ":" +
        constants.apiPort +
        "/register-cams/single-cam?cam_id=" +
        num_cam
    );
  },
  getLimitsCam: () => {
