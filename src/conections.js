...
export default {
    ...
    dashboardRecognitionPerDay:(filter = '')=>{        
        return Axios.get(constants.sails_url + ':1337/dashboard/peoplefordays'+filter)
    },
    dashboardRecognitionMood:()=>{        
        return Axios.get(constants.sails_url + ':1337/dashboard/mood')
    },
    loadCams:()=>{        
        return Axios.get( constants.sails_url + ':1337/cams?sort=num_cam asc&active=1&limit=1000&populate=false')
    },
    changeCamStatus:(id)=>{        
