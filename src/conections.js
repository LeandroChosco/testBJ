...
export default {
    ...
    snapShotV2:(camara_id)=>{
        const user_id = getUserID() 
        console.log(constants.sails_url+':'+constants.sailsPort+'/control-cams/screenshotV2/' + camara_id+'/?user_id='+user_id)
    ...
    getCamDataV2:(camera_id)=>{
        const user_id = getUserID() 
        // console.log(constants.sails_url + ':' + constants.sailsPort + '/control-cams/' + camera_id + '/data?user_id='+user_id)
        return Axios.get(constants.sails_url + ':' + constants.sailsPort + '/control-cams/' + camera_id + '/data?user_id='+user_id)
    },

    getAllCams:()=>{
        const user_id = getUserID() 
        console.log(constants.sails_url+':'+constants.sailsPort+'/control-cams/all-cams/?user_id='+user_id)
    ...
    getCamDataHistory:(camera_id, num_cam)=>{
        ...
        const user_id = getUserID() 
        console.log(constants.sails_url+':'+constants.sailsPort+'/control-cams/'+camera_id+'/'+num_cam+'/video-history/?user_id='+user_id)
    ...
    /*getMatchAPI: data =>{
        if(data !== undefined){
            return Axios.get(constants.sails_url+':'+constants.sailsPort+'/matchapi/?id_match=' +data)
        } else {
            return Axios.get(constants.sails_url+':'+constants.sailsPort+'/matchapi/')
        }
    },*/
    ...
    getComplaints: data => {
        if (data !== undefined) {
            return Axios.get(
            constants.sails_url+':'+constants.sailsPort+'/getcomplaints/?id_complaint=' + data
            );
        } else {
