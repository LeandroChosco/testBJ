...
export default {
    ...
    dashboardCams:()=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/dashboard/cams')
    },
    dashboardTickets:()=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/dashboard/tickets')
    },
    dashboardTotalRecognition:()=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/dashboard/detected')
    },
    dashboardRecognitionAges:()=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/dashboard/ageranges')
    },
    dashboardRecognitionPerDay:(filter = '')=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/dashboard/peoplefordays'+filter)
    },
    dashboardRecognitionMood:()=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/dashboard/mood')
    },
    loadCams:()=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/cams?sort=num_cam asc&active=1&limit=1000&populate=false')
    },
    changeCamStatus:(id)=>{        
    ...
    getCamMatches:(num_cam)=>{        
        return Axios.get(/* constants.base_url+ */'http://prod.adminc5.mh.energetikadevelepment.com:1337/matchApi?num_cam='+num_cam)
    }
