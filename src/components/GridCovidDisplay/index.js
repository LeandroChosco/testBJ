...
class GridCameraDisplay extends Component {
  state = {
    ...
    photos2: [
      {
        name:
          "172.20.39.15_01_20200611171200261_MEASURE_TEMP_ALARM_DETECTION.jpg",
        relative_url:
          "http://54.90.17.212/camptemp/camtemp/172.20.39.15_01_20200611171200261_MEASURE_TEMP_ALARM_DETECTION.jpg"
      },
      {
        name:
          "172.20.39.15_01_20200611171200261_MEASURE_TEMP_ALARM_DETECTION.jpg",
  ...
  _loadFiles = cam => {
    ...
    //     }, 100);
    //   });
    conections.getTermicFiles().then(async response => {
      console.log(response);
      this.setState({
        imageLoading: false,
        loading: false,
        urlPhotos: response.data.data.relative_path,
        photos: response.data.data.files
      });
    });
  };
