              ...
              <div className=" imageContainer row">
                <div className="col-12 limitlines" align="left">
                  ...
                  <div className="textcontainerdescription">
                    <p>
                      El usuario <b>{this.props.info.user_name}</b>{" "}
                      {this.props.info.id_problem !== 0
                        ? this.state.cat_problems[this.props.info.id_problem]
                        : "esta reportando el siguiente problema: " +
                          this.props.info.msg}
                    </p>
                  </div>
                  <div align="right">
