...

            {
                options && series ?
                    <Row>
                        ...
                        <br />
                            <Row>
                                <Col className='col-4'><BsCameraVideoFill style={{ color: "#008ffb", border: "none", width: "70%", height: "50%" }} /></Col>
                                <Col className='col-8'>
                                    <Row style={{marginTop: "0.75rem"}}>
                                        <p>
                                            <b style={{ color: "#008ffb" }}>{dataCams.filter((el) => el.name === "Activas")[0].value} cámaras</b> activas
                                        </p>
                                    </Row>
                                </Col>
                            </Row>
                            <Row>
                                <Col className='col-4'><BsCameraVideoOffFill style={{ color: "#00e396", border: "none", width: "70%", height: "50%" }} /></Col>
                                <Col className='col-8'>
                                    <Row style={{marginTop: "0.75rem"}}>
                                        <p>
                                            <b style={{ color: "#00e396" }}>{dataCams.filter((el) => el.name === "Inactivas")[0].value} cámaras</b> inactivas
                                        </p>
                                    </Row>
                                </Col>
                            </Row>
