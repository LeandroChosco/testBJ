            ...
            >
              <div className="col-12" align="left">
                ...
                <div className="row">
                  ...
                  {this.props.info.userInfo.Person ? (
                    <div className="col-7">
                      {this.props.info.userInfo.Person.name}{" "}
                      {this.props.info.userInfo.Person.surname}{" "}
                      {this.props.info.userInfo.Person.lastname}
                    </div>
                  ) : null}
                </div>
                <Divider />
                <div className="row">
                  ...
                  <div className="col-7">{this.props.info.title}</div>
                </div>
                <Divider />
                <div className="row">
                  <div className="col-5">
                  ...
                  <div className="col-7">{this.props.info.dateTime}</div>
                </div>
