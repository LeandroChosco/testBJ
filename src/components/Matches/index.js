  ...
  render() {
    return (
      <React.Fragment>
        ...
        <button
          className={
            this.state.showSideBar ? "matches-arrow-display-none" : null
          }
          onClick={() =>
            this.setState({ showSideBar: !this.state.showSideBar })
          }
        ...
        <div
          ...
          className={
            this.state.small
              ? "sidenav-right matchesContainer"
              : "sidenav-right active-side"
          }
        >
          <div align="center">
            {/* <div
              className={
                this.state.showSideBar ? null : "matches-arrow-display-none"
              }
            > */}
            {this.props.matchs.map((value, index) => (
              <Match
                _toggleSmallBig={this._toggleSmallBig}
                key={index}
                isSmall={this.state.small}
                info={value}
              />
            ))}
            {/* </div> */}
