...
class GridCameraDisplay extends Component {
      ...
      <div className="gridCameraContainer" align="center">
        ...
        <div
          className={
            !this.state.autoplay
              ? !this.props.showMatches
                ? "sin-margin camGridControl showfiles"
                : "con-margin camGridControl showfiles"
              : !this.props.showMatches
              ? "sin-margin camGridControl"
              : "con-margin camGridControl"
          }
        >
          ...
          <div className="row stiky-top">
            <div className="col-4">
                ...
                this.props.moduleActions.btnsnap ? (
                  <Button
                    ...
                    disabled={
                      ...
                      this.state.loadingRcord ||
                      this.props.loadingFiles ||
                      this.state.restarting ||
                      this.state.recordingCams.indexOf(
                        this.state.selectedCamera
                      ) > -1
                    }
                    loading={this.state.loadingSnap}
                    onClick={() => this._snapShot(this.state.selectedCamera)}
                  >
              ...
              {this.props.moduleActions ? (
                this.props.moduleActions.btnrecord ? (
                  <Button
                    ...
                    loading={this.state.loadingRcord}
                    onClick={() =>
                      this._recordignToggle(this.state.selectedCamera)
                    }
                  >
                    <i
                      className={
              ...
              <Button
                ...
                disabled={
                  ...
                  this.props.loadingFiles ||
                  this.state.restarting ||
                  this.state.recordingCams.indexOf(this.state.selectedCamera) >
                    -1
                }
                circular
                onClick={() =>
              ...
              <Button
                ...
                circular
                onClick={() => this.props.makeReport(this.state.selectedCamera)}
              >
                {" "}
              ...
              <Button
                ...
                circular
                onClick={() =>
                  this.props.changeStatus(this.state.selectedCamera)
                }
              >
                {" "}
            ...
            <div className="col-5">
              <b>Camara {this.state.selectedCamera.num_cam}</b>{" "}
                          ...
                          <div className="row">
                            {this.state.videos.map((value, index) => (
                              <MediaContainer
                                ...
                                value={value}
                                cam={
                                  this.state.markers[this.state.slideIndex]
                                    .extraData
                                }
                                reloadData={this._loadFiles}
                                video
                            ...
                            <Tab.Pane attached={false}>
                              {this.state.video_history !== null ? (
                                this.state.video_history[0] ? (
                                  this.state.video_history[1].map(
                                    (row, count) => (
                                  ...
                                  <div align="center">
                                    <p className="big-letter">
                                      No hay archivos que mostrar111
                                    </p>
                                    <i className="fa fa-image fa-5x"></i>
                                  </div>
                                )
                ...
                ? this.props.matches.map((value, index) => {
                    ...
                    return (
                      <Match
                        key={index}
                        info={value}
                        toggleControls={this._closeControl}
                      />
                    );
                  })
                : null}
  ...
  _restartCamStream = async () => {
    ...
    await this.refs[
      "camrefgrid" + this.state.selectedCamera.id
    ]._restartCamStream();
