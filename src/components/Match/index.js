    ...
    if (this.props.isSmall) {
      return (
        <div
          ...
          onClick={this.props._toggleSmallBig}
        >
          ...
          {this.props.info.faceImage ? (
            <Image
              ...
              src={"data:image/png;base64," + this.props.info.faceImage}
            />
          ) : (
            <Image
              style={{ height: "100%", width: "100%", borderRadius: 30 }}
              src={
                this.props.info.name
                  ? "http://95.216.37.253:3000/images/" +
                    this.props.info.name.replace(/ /g, "") +
                    "/" +
                    this.props.info.messageId +
                    "-face.jpeg"
                  ...
                  <div align="right">
                    {this.props.info
                      ? this.props.info.dateTime
                        ? this.props.info.dateTime
                        : new Date(this.props.info.DwellTime).toLocaleString()
                      : "25-03-2019 14:35"}
                  </div>
                    ...
                    <span
                      className={
                        this.props.info.status
                          ? "badge badge-success"
                          : this.props.info.status === undefined
                          ? "badge badge-success"
                          : "badge badge-danger"
                      }
                    >
